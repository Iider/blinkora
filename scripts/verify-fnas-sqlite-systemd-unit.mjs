...
const unitFile = new URL('../deploy/fnas/blinkora-sqlite.service', import.meta.url);
const expected = new Map([
  ...
  ['Service', new Map([
    ...
    ['User', 'weio'],
    ['Group', 'Users'],
    ['WorkingDirectory', '/vol1/1000/docker/blinkora-sqlite/local'],
    ['EnvironmentFile', '/vol1/1000/docker/blinkora-sqlite/local/blinkora.env'],
...
console.log('FNAS SQLite systemd unit template is valid');
