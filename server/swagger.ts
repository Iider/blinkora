...
const trpcOpenApiDocument = generateOpenApiDocument(appRouter, {
  title: 'Blinkora TRPC API',
  description: 'blinkora tRPC API',
  version: '1.0.0',
  baseUrl: '/api',
  tags: ['Note', 'User', 'Task', 'Tag', 'Public', 'Config', 'File', 'Comment', 'Workspace', 'Font'],
  securitySchemes: {
    bearer: {
      type: 'http',
      scheme: 'bearer',
...
const expressSwaggerOptions = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Blinkora Express API',
      version: '1.0.0',
      description: 'Blinkora Express API Documentation',
    },
    servers: [
      {
        url: '/api',
