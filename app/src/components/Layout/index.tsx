...
import { BlinkoraRightClickMenu } from '@/components/BlinkoraRightClickMenu';
  ...
  return (
    <div className={`flex w-full h-mobile-full overflow-x-hidden`} id="outer-container">
      ...
      >
        {/* nav bar  */}
        <header
          className="blinkora-mobile-header relative flex md:h-16 md:min-h-16 h-14 min-h-14 items-center justify-between gap-2 px-2 md:px:4 pt-2 md:pb-2 overflow-hidden"
          style={!isPc ? {
            position: 'fixed',
            top: 0,
          ...
          <div className="flex max-w-full items-center gap-2 md:p-2 w-full z-[1]">
            ...
            <div className="flex flex-1 items-center justify-between">
                ...
                <div className="flex flex-row items-center gap-1">
                  ...
                  {searchParams.get('path') != 'trash' ? (
                    <Icon
                      ...
                      onClick={() => {
                        blinkoraStore.refreshData();
                        blinkoraStore.updateTicker++;
                      }}
                    ...
                    <Icon
                      ...
                      onClick={() => {
                        showTipsDialog({
                          size: 'sm',
                          title: t('clear-recycle-bin'),
                          content: t('clear-recycle-bin-confirm'),
                          onConfirm: async () => {
              ...
              <div className="flex items-center justify-center gap-2 md:gap-4 w-auto ">
                ...
                <FilterPop />
                {!blinkoraStore.config.value?.isCloseDailyReview && <Badge size="sm" className="shrink-0" content={blinkoraStore.dailyReviewNoteList.value?.length} color="warning">
                  <Link to="/review">
                    <Button
                      as="a"
                      className="mt-[2px]"
