  ...
  >
    ...
    <Item
      ...
      rightContent={<ThemeColor
        value={blinkora.config.value?.themeColor}
    ...
    <Item
      ...
      rightContent={<LanguageSwitcher value={blinkora.config.value?.language} onChange={value => {
    ...
    <Item
      ...
      rightContent={<Switch
        isSelected={blinkora.config.value?.isOrderByCreateTime}
        onChange={e => {
          PromiseCall(api.config.update.mutate({
    ...
    <Item
      ...
      rightContent={
        <Switch
          isSelected={blinkora.config.value?.isCloseDailyReview}
          onChange={e => {
            PromiseCall(api.config.update.mutate({
    ...
    <Item
      ...
      rightContent={<div className="flex gap-2 w-full justify-end">
        <SelectDropdown
          value={blinkora.config.value?.smallDeviceCardColumns}
        ...
        />
        <SelectDropdown
          value={blinkora.config.value?.mediumDeviceCardColumns}
        ...
        />
        <SelectDropdown
          value={blinkora.config.value?.largeDeviceCardColumns}
    ...
    <Item
      ...
      rightContent={
        <SelectDropdown
          value={blinkora.config.value?.timeFormat}
    ...
    <Item
      ...
      rightContent={
        <FontSwitcher fontname={blinkora.config.value?.fontStyle} onChange={async fontname => {
          await PromiseCall(api.config.update.mutate({
            key: 'fontStyle',
            value: fontname
          }))
    ...
    <Item
      ...
      rightContent={
        <Tooltip content={<GradientBackground className="rounded-lg w-[200px] h-[100px]">
          ...
          <Switch
            isSelected={blinkora.config.value?.isCloseBackgroundAnimation}
            onChange={e => {
              PromiseCall(api.config.update.mutate({
...

    {
      user.isSuperAdmin && (
        <Item
          ...
          rightContent={
            <Switch
              isSelected={blinkora.config.value?.signinFooterEnabled ?? false}
              onChange={async (e) => {
                await PromiseCall(api.config.update.mutate({
