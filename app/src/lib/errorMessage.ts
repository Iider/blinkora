...
const exactErrorKeys: Record<string, string> = {
  ...
  "target workspace is required": "error.target-workspace-required",
  "target workspace not found": "error.target-workspace-not-found",
  "cannot move note to current workspace": "error.cannot-move-note-to-current-workspace",
  "cannot move recycled note": "error.cannot-move-recycled-note",
